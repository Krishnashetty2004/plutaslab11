  ...
  return (
    <section className="min-h-screen bg-black px-6 py-20 md:px-12 md:py-32">
      <div className="max-w-4xl mx-auto">
        <h2 className="text-5xl md:text-6xl font-serif font-bold text-white mb-8 tracking-tight">About Plutas Lab</h2>
        ...
        <div className="space-y-6 text-lg text-gray-300 leading-relaxed">
          ...
          <div className="pt-8 border-t border-gray-700">
            <p className="text-xl text-white font-semibold">We build therefore we are.</p>
          </div>
        </div>
      </div>
    </section>
